...
# historicaltrades = client.get_historical_trades(symbol='BNBBTC')
info = client.get_account()

trades = client.get_my_trades(symbol='ETHBTC')
Trades = client.my_trades("BTCUSDT")
fees = client.get_trade_fee(symbol='ETHBTC')
...
# print(binance_client.get_klines("ETHBTC", "5m"))
...
#         print('All caught up..!')
#     return data_df
# data = get_all_binance("ETHBTC", "5m", save = True)
# # %%
